...
public class FormularioEmpresa extends Formulario {
    ...
    public FormularioEmpresa(String nombre, String email, String nombre1, int cuit, String provincia, String localidad, String direccion, int telefono, List<FormularioOferta> ofertas) {
        super(nombre, email);
        this.cuit = cuit;
